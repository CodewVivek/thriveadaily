...
const RegisterPage: React.FC<RegisterPageProps> = ({ onBack, onSuccess }) => {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      // Note: Google sign-in will redirect, so we don't need to call onSuccess here
    } catch (err) {
      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex justify-center mb-6">
            <div className="w-16 h-12 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center shadow-xl">
              <Target className="w-8 h-8 text-white" />
            </div>
          </div>
          
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Join Thrive Daily</h1>
          <p className="text-gray-600">Start your journey to extraordinary results</p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
          ...
          <button
            ...
            className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-xl text-gray-700 bg-white hover:bg-gray-50 transition-colors duration-200 mb-6 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {googleLoading ? (
